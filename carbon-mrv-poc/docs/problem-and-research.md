...
This PoC demonstrates a minimal version: dataset commitments, signed attestations, and a simple registry, with a path to onchain anchoring and alignment with cypherpunk design goals (see [Design philosophy](design-philosophy.md)).
